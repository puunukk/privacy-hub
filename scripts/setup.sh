...
echo ""
echo "⏳ Configuring Pi-hole password..."
# This is the critical fix - Pi-hole password must be set after container starts
docker exec pihole pihole setpassword "$PIHOLE_PASSWORD"
echo "✅ Pi-hole password configured!"
...
echo "   • Theme: $SEARXNG_DEFAULT_THEME"
echo "   • Safe Search: $SEARXNG_SAFE_SEARCH"
echo "   • Language: $SEARXNG_DEFAULT_LANG"
echo ""
...
echo "   ./scripts/manage.sh password   # Reset Pi-hole password"
echo "   ./scripts/manage.sh ssl        # Update SSL certificates"
echo "   ./scripts/manage.sh diagnose   # Run diagnostics" 