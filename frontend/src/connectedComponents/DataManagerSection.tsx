...
import {
  Database, Eye, EyeOff,
  Activity, AlertCircle, CheckCircle, Clock, Settings, XCircle
} from 'lucide-react';
...
class DataManagerSection extends PureComponent<DataManagerMonitorProps, DataManagerSectionState> {

  state: DataManagerSectionState = {
    isExpanded: false,
    showDetails: false
  }
  ...
  render() {
    ...
    const { containers, dockerInfo, systemMetrics, systemInfo, hasErrors, errors } = this.props;
    ...
    return (
      ...
      >
        {isExpanded && (
          <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-sm border ${this.getStatusColor()}`}>
            {/* Header */}
...
export const ConnectedDataManagerMonitor = connect(mapStateToProps, mapDispatchToProps)(DataManagerSection);
