            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white">{networkInfo.gateway}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  <span className="text-sm text-gray-500">DHCP Client:</span>
                  <span className={`text-sm font-medium ${networkInfo.isDhcpClient ? 'text-green-600' : 'text-yellow-600'}`}>
                ...
                <div className="pt-2 border-t border-gray-100">
                  ...
                  {isDnsConfigured ? (
                    <p className="text-xs text-green-600">✓ Pi-hole is configured as DNS server</p>
                  ) : (
